...
format:
  letterbox-revealjs: 
    ...
    slide-number: c/t
    footer: "🔗[cynthiahqy/positconf2026](https://github.com/cynthiahqy/positconf2026)"
  pptx: default
---

<!--TODO: add file names to all visible code chunks -->
...
![](assets/notability-v2/separate-prep-and-ggplot.png){.fragment .fade-in-then-out fragment-index=1 fig-alt="Data prep block beside a ggplot() block"}

<!--- TODO: REPLACE THESE TWO BLOCKS WITH A WHITE PLACEHOLDER THE SAME SIZE AS @GGPLOT2-HELPER-WRAPPED; ANIMATION SHOULD GO FROM BLANK -->
![](assets/notability/ggplot2-helper-wrapped.png){.fragment fragment-index=2 fig-alt="The same two blocks with a box drawn around them to show the selection"}
:::
...
<!-- TODO: center align -->
![](assets/notability-v2/transparent-helper-left.png)
...
:::
::: {.column .small .fragment}
```{.r code-line-numbers="10-20|1-5|6-9|" filename="function-interface"}
...
<!-- TODO: animate between next two slides -->
...
::: {.sketch-container}
![](assets/notability-v2/code-to-helper.png)
:::
...
::: {.sketch-container}
![](assets/notability-v2/code-to-helper-output.png)
:::
...
![cynthiahqy.com/survey](assets/qr-positconf2026.png){.qr-code fig-alt="QR code linking to github.com/cynthiahqy/positconf2026"}
