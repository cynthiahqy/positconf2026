...
## Design principles for transparent helpers

::: {.sketch-container}
![](assets/notability-v2/principle-summary-v2-with-text.png){fig-alt="Modular internals, an exposed helper signature, and a documentation page shown together"}
:::
...
```{.r code-line-numbers="|4-13|29-32" filename="internals"}
gg_facet_wrap_months <- function(
  .events_long, date_col, locale = NULL,
  week_start = NULL, nrow = NULL, ncol = NULL,
  .geom = list(
...
## From `autoplot()` {auto-animate=true .smallest}
...
## From `autoplot()` to customisation! {auto-animate=true .smallest}
