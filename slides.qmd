...
Photo from posit::conf(2024)

## Today

- how wanting to package up the calendar I made led to STRONG opinions on helper functions.
...
# How should I package *my* magical calendar recipe?

<!-- ## But what about ggplot recipes can get long...
...
## Especially for things ggplot2 wasn't designed for... {visibility="hidden"}

![](assets/calendars/image.png)


## What's in my ggplot2 recipe?
...
## My solution: Transparent 'Window' Helpers

![Expose, separate, instruct](assets/notability/ggplot2-helper-design-principles-summary.png)
