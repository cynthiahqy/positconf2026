...
## What about the 'Grammar of Graphics'? 🪄
...
```
## Wrap everything into helper functions!

::: {.image-placeholder}
IMAGE/ILLUSTRATION -- ggplot -> helper
:::

## But not all helper functions are made equal...
...
```{.r code-line-numbers="1|1-4|5|5-9|10|10-19|20"}
...
```{.r code-line-numbers="1|2|2-5|7-8|9-15|16-19|1-22"}
...
* explain documentation approach
